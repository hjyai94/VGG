...
testing_fire_image_path = 'test/fire/'
testing_non_fire_image_path = 'test/non_fire/'

training_labels = []
testing_labels = []

# 加载训练数据
training_images = glob.glob(training_fire_image_path + '*.jpg')
training_images[len(training_images):len(training_images)] = glob.glob(training_non_fire_image_path + '*.jpg')
